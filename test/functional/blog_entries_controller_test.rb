...
class BlogEntriesControllerTest < ActionController::TestCase
  ...
  test "should create blog_entry" do
    assert_difference('BlogEntry.count') do
      post :create, blog_entry: { content: @blog_entry.content, published: @blog_entry.published, title: @blog_entry.title }
    end
  ...
  test "should update blog_entry" do
    put :update, id: @blog_entry, blog_entry: { content: @blog_entry.content, published: @blog_entry.published, title: @blog_entry.title }
    assert_redirected_to blog_entry_path(assigns(:blog_entry))
  end
